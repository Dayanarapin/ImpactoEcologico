public class Edificio implements ImpactoEcologico {
    ...
    public Edificio(double emisionesConstruccion, double consumoEnergetico, double residuosConstruccionDemolicion, double eficienciaEnergetica) {
    ...
    public double calcularImpactoEcologico() {
        return emisionesConstruccion + consumoEnergetico - eficienciaEnergetica + residuosConstruccionDemolicion;
    }
